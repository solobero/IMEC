...
<section>
    ...
    <div style="text-align: center;">
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: rgba(0, 0, 0, 0.5); color: white; font-size: 20px; font-weight: bold; padding: 10px; border-radius: 8px;">
            ...
            <a href="{{ route('lang.switch', ['lang' => 'en']) }}" class="btn btn-sm btn-outline-light me-2">English</a>
            <a href="{{ route('lang.switch', ['lang' => 'es']) }}" class="btn btn-sm btn-outline-light">Español</a>
        </div>
    </div>
</section>
@endsection
